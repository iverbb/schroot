...
namespace schroot
{
  ...
  schroot::keyfile::group_list
  schroot::keyfile::get_groups () const
  {
    group_list ret;
  ...
  schroot::keyfile::key_list
  schroot::keyfile::get_keys (const group_name_type& group) const
  {
    key_list ret;
  ...
  void
  schroot::keyfile::check_keys (const group_name_type& group,
  ...
  bool
  schroot::keyfile::has_group (const group_name_type& group) const
  {
    return (find_group(group) != 0);
  }

  bool
  schroot::keyfile::has_key (const group_name_type& group,
  ...
  void
  schroot::keyfile::set_group (const group_name_type& group,
  ...
  schroot::keyfile::comment_type
  schroot::keyfile::get_comment (const group_name_type& group) const
  {
    const group_type *found_group = find_group(group);
    if (found_group)
  ...
  schroot::keyfile::comment_type
  schroot::keyfile::get_comment (const group_name_type& group,
                                 const key_type&        key) const
  {
  ...
  schroot::keyfile::size_type
  schroot::keyfile::get_line (const group_name_type& group) const
  {
    const group_type *found_group = find_group(group);
    if (found_group)
  ...
  schroot::keyfile::size_type
  schroot::keyfile::get_line (const group_name_type& group,
                              const key_type&        key) const
  {
    const item_type *found_item = find_item(group, key);
    if (found_item)
  ...
  bool
  schroot::keyfile::get_locale_string (const group_name_type& group,
                                       const key_type&        key,
  ...
  void
  schroot::keyfile::remove_group (const group_name_type& group)
  {
  ...
  void
  schroot::keyfile::remove_key (const group_name_type& group,
                                const key_type&        key)
  {
  ...
  schroot::keyfile&
  schroot::keyfile::operator += (const keyfile& rhs)
  {
  ...
  schroot::keyfile
  operator + (const schroot::keyfile& lhs,
              const schroot::keyfile& rhs)
  {
    schroot::keyfile ret(lhs);
    ret += rhs;
    return ret;
  }
  ...
  schroot::keyfile::group_type *
  schroot::keyfile::find_group (const group_name_type& group)
  {
    group_map_type::iterator pos = this->groups.find(group);
    if (pos != this->groups.end())
      return &pos->second;
  ...
  const schroot::keyfile::item_type *
  schroot::keyfile::find_item (const group_name_type& group,
                               const key_type&        key) const
  {
    const group_type *found_group = find_group(group);
    if (found_group)
  ...
  void
  schroot::keyfile::check_priority (const group_name_type& group,
                                    const key_type&        key,
                                    priority               priority,
                                    bool                   valid) const
  {
